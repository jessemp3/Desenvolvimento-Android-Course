...
class MensagemAdapter(
    ...
    inner class MensagemViewHolder(val view: View) : RecyclerView.ViewHolder(view) {
        val imagePerfil: ImageView = view.findViewById(R.id.imagePerfil)
        val textNome: TextView = view.findViewById(R.id.textName)
        val textMensagem: TextView = view.findViewById(R.id.textMensagem)
