...
class TarefaDAO(context: Context) : ITarefaDAO {
    ...
    override fun atualizar(tarefa: Tarefa): Boolean {
        ...
        contentvalues.put(DatabaseHelper.COLUNA_DESCRICAO, tarefa.descricao)
        ...
        escrita.update(
            ...
            e.printStackTrace()
            Log.d("DatabaseHelper", "Erro ao atualizar tarefa")
            return false
        }
        return true
    }
    ...
    override fun remover(idTarefa: Int): Boolean {
        ...
        try {
            ...
            Log.d("DatabaseHelper", "Tarefa removida com sucesso")
        }catch (e: Exception){
            e.printStackTrace()
            Log.d("DatabaseHelper", "Erro ao remover tarefa")
            return false
        }
        return true
    }
