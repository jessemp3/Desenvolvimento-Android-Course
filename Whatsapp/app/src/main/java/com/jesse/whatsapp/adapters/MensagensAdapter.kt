...
import com.jesse.whatsapp.databinding.ItemMensagensDestinatarioBinding
import com.jesse.whatsapp.databinding.ItemMensagensRemetenteBinding
...
class MensagensAdapter : Adapter<ViewHolder>() {
    ...
    class MensagensRemetenteViewHolder(//ViewHolder
        ...
        fun bind(mensagem: Mensagem) {
            binding.textViewMensagemRemetente.text = mensagem.mensagem
        }
    ...
    class MensagensDestinatarioViewHolder(//ViewHolder
        ...
        fun bind(mensagem: Mensagem) {
            binding.textViewMensagemDestinatario.text = mensagem.mensagem
        }
